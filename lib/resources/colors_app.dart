...
class AppColors {
  static const Color base = Color(0xFFF7FBFF);
  static const Color fondo = Color(0xFFEAF6FB);
  static const Color blanco = Color(0xFFFFFFFF);
  static const Color texto = Color(0xFF3A506B);
  static const Color primarioSuave = Color(0xFFBFD7EA);
