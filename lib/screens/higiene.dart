...
class _HigieneScreenState extends State<HigieneScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(AppStrings.moduloHigiene),
        backgroundColor: AppColors.colorHigiene,
      ),
      body: Padding(
        ...
        child: Column(
          children: [
          Text(
          '¡Bienvenido al módulo de Higiene! Completa los niveles para avanzar.',
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton.icon(
              ...
              style: ElevatedButton.styleFrom(
                foregroundColor: Colors.white, backgroundColor: AppColors.colorHigiene,
