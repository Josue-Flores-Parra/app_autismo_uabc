      ...
      builder: (context, viewModel, child) {
        ...
        if (activeStepIndex != -1 &&
            viewModel
                    ...
                    .length >
                activeStepIndex) {
          activeNodePosition = viewModel
              .nodePositions[activeStepIndex];
        }
