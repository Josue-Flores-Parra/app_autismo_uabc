...
class _AvatarScreenState extends State<AvatarScreen> {
              ...
              children: [
                Expanded(
                  child: Padding(
                    ...
                    child: Image.asset(skin.imagenBase, fit: BoxFit.contain),
                  ),
                ),
                Container(
        ...
        itemBuilder: (context, index) {
          if (index == 0) {
            ...
            return _buildCard(
              ...
              child: const Center(
                child: Icon(Icons.close, color: Colors.white54, size: 40),
              ),
            );
          }
  ...
  Widget _buildBackgroundsSection(
    ...
    final backgrounds = viewModel.availableBackgrounds;
    return SizedBox(
      height: 100,
      child: ListView.builder(
        scrollDirection: Axis.horizontal,
        ...
        itemBuilder: (context, index) {
          ...
          final isSelected =
              viewModel.currentEstado.backgroundActual == background;
          return _buildCard(
            context,
            120,
            isSelected,
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(15),
          border: Border.all(
            color: isSelected ? neonColor : Colors.white24,
            width: isSelected ? 3 : 1,
          ),
          boxShadow: isSelected
              ? [BoxShadow(color: neonColor, blurRadius: 10, spreadRadius: 2)]
              : null,
        ),
        child: Material(
        ...
        Row(
          children: [
            SizedBox(
              width: 56,
              height: 56,
              child: _buildFaceButton(viewModel.currentEstado.felicidad),
            ),
            const SizedBox(width: 8),
            Expanded(
              child: SizedBox(
                height: 56,
                child: _buildNameButton(viewModel.currentEstado.nombre),
              ),
            ),
            const SizedBox(width: 8),
          ...
          children: [
            Expanded(
              child: _buildStatButton(
                label: 'Felicidad',
                value: viewModel.currentEstado.felicidad,
            ...
            Expanded(
              child: _buildStatButton(
                label: 'Energía',
                value: viewModel.currentEstado.energia,
                gradientColors: const [Color(0xFF92C5BC), Color(0xFF5A97B8)],
              ),
            ),
            const SizedBox(width: 6),
            Expanded(
              child: _buildStatButton(
                label: 'Monedas',
                value: viewModel.currentEstado.monedas,
  ...
  Widget _buildFaceButton(int felicidad) {
    String imagePath;
    Color neonColor;
    if (felicidad > 70) {
      ...
      neonColor = const Color(0xFFFF3030);
    }
    return _buildButton(
      neonColor,
      () {},
  ...
  Widget _buildNameButton(String nombre) => _buildButton(
    Colors.transparent,
    () {},
    Center(
      child: Text(
  ...
  Widget _buildEditButton(BuildContext context) => _buildButton(
    ...
    () => context.read<AvatarViewModel>().toggleEditPanel(),
    const Center(child: Icon(Icons.edit, color: Colors.white, size: 22)),
  );

  Widget _buildButton(Color shadowColor, VoidCallback onTap, Widget child) {
    return Container(
      decoration: BoxDecoration(
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [
          ...
          BoxShadow(color: gradientColors[0], blurRadius: 15, spreadRadius: 1),
        ],
      ),
      child: Material(
        color: Colors.transparent,
                  ...
                  children: [
                    ...
                    if (icon != null)
                      Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          Icon(icon, color: gradientColors[0], size: 12),
                          const SizedBox(width: 2),
                          Text(
                            '$value',
                            style: TextStyle(
                              ...
                              fontWeight: FontWeight.bold,
                              shadows: [
                                Shadow(color: gradientColors[0], blurRadius: 6),
                              ],
                            ),
                          ),
                        ],
                    ...
                    child: FractionallySizedBox(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(10),
                          boxShadow: [
                            BoxShadow(color: gradientColors[0], blurRadius: 6),
                          ],
                        ),
                      ),
                    ),
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(15),
          border: Border.all(
            color: isSelected ? const Color(0xFFFF8C00) : Colors.white24,
            width: isSelected ? 3 : 1,
          ),
          boxShadow: isSelected
              ? [
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: Material(
                          ...
                          child: InkWell(
                            borderRadius: BorderRadius.circular(18),
                            onTap: tieneSuficientes
                                ? () async {
                                    final exito = await viewModel
                                        .desbloquearAccesorio(accesorio);
