...
class AvatarRepository {
  ...
  */
  static List<SkinInfo> obtenerSkinsDisponibles() {
    return [
      // Skin Default (tiene expresiones)
      SkinInfo(
        nombre: 'Default',
        imagenBase: 'assets/images/Skins/DefaultSkin/default.png',
        carpetaBackground: 'assets/images/Skins/DefaultSkin/backgrounds/',
        expresiones: [
      ...
      SkinInfo(
        nombre: 'Astronaut',
        imagenBase: 'assets/images/Skins/Astronaut/astronauta.png',
        carpetaBackground: 'assets/images/Skins/Astronaut/backgrounds/',
        expresiones: [
      ...
      SkinInfo(
        nombre: 'Chef',
        imagenBase: 'assets/images/Skins/Chef/chefskin.png',
        carpetaBackground: 'assets/images/Skins/Chef/backgrounds/',
        expresiones: [
  ...
  */
  static List<AccesorioGeneral> obtenerAccesoriosGenerales() {
    return [
      AccesorioGeneral(
        nombre: 'Antenitas',
        imagenPath: 'assets/images/Skins/accesorios generales/antenitas.png',
        top: -40,
        width: 250,
        height: 250,
        bloqueado: false, // Gratis desde el inicio
        costoMonedas: 0,
      ),
      AccesorioGeneral(
        nombre: 'Corona',
        imagenPath: 'assets/images/Skins/accesorios generales/corona.png',
        top: -37,
        width: 280,
        height: 280,
        bloqueado: true, // Requiere desbloqueo
        costoMonedas: 50,
      ),
      AccesorioGeneral(
        nombre: 'Diadema Joyas',
        imagenPath: 'assets/images/Skins/accesorios generales/diademajoyas.png',
        top: -15,
        width: 260,
        height: 260,
        bloqueado: true, // Requiere desbloqueo
      ...
      AccesorioGeneral(
        nombre: 'Gafas',
        imagenPath: 'assets/images/Skins/accesorios generales/gafas.png',
        top: 55,
        width: 260,
        height: 260,
        bloqueado: false, // Gratis desde el inicio
      ...
      AccesorioGeneral(
        nombre: 'Halo Dorado',
        imagenPath: 'assets/images/Skins/accesorios generales/halodorado.png',
        top: -40,
        width: 240,
        height: 240,
        bloqueado: true, // Requiere desbloqueo
