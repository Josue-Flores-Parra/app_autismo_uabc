...
class _AudioMinigameState extends State<AudioMinigame> {
  ...
  bool _audioFinished =
      false; // Rastrear si el audio se reprodujo completamente
        ...
        .catchError((error) {
          if (mounted && !_isDisposed) {
            setState(() {
              _hasError = true;
              _errorMessage =
                  'Error al cargar el audio. Verifica la ruta: $audioUrl';
            });
          }
        });
  }
    ...
    _positionTimer = Timer.periodic(const Duration(milliseconds: 500), (timer) {
      ...
      if (duration != null && duration.inMilliseconds > 0) {
        ...
        if (isAtEnd && !_audioFinished) {
          setState(() {
            _audioFinished =
                true; // Marcar que el audio se reprodujo completamente
          });
        }
      ...
      return Scaffold(
        ...
        body: Center(
          child: _hasError
              ...
              : const CircularProgressIndicator(color: Color(0xFF05E995)),
        ),
      );
    }
                          ...
                          children: [
                            Slider(
                              value: _viewModel!.position.inMilliseconds
                                  ...
                                  .clamp(
                                    0.0,
                                    _viewModel!.duration!.inMilliseconds
                                        .toDouble(),
                                  ),
                              min: 0.0,
                              max: _viewModel!.duration!.inMilliseconds
                                  .toDouble(),
                              onChanged: (value) {
                                if (_viewModel != null &&
                                    !_isDisposed &&
                      ...
                      ElevatedButton.icon(
                        ...
                        icon: Icon(
                          _isCompleted
                              ...
                              : Icons.lock_outline,
                          color: _isCompleted || !_audioFinished
                              ? Colors.white70
                              : Colors.white,
                          size: 32,
                        ),
